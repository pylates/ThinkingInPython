...
% ------------ Preguntar! 02 de Noviembre ------------ ¿revisar?
...
%------------Miércoles 02 de Noviembre -------------------________________-
\subsection{Ejercicios}

        1. Instalar el código fuente árbol de este libro y asegurar que usted tenga una utilidad \textbf{make} instalada en su sistema.     \newline
